   ...
   if(tar.tagName=="BUTTON"){
      ...
      if(tar.getAttribute("id")=="pagoTransferencia"){
         ...
         document.querySelector(".tot2 b").innerHTML=`
            ${"$ ".concat(parseInt(document.querySelector(".tot b").innerHTML.replaceAll("$ ",""))+35)}
         `
      }
      tmpmsj = ` *Dirección:* ${document.getElementById("datosDomicilio")[0].value} *Referencia:* ${document.getElementById("datosDomicilio")[1].value} *Nombre:* ${document.getElementById("datosDomicilio")[2].value}.* - *Total a pagar:* $ ${parseInt(document.querySelector(".tot b").innerHTML.replace("$",""))+35} - *Pago:* ${tmpmsj2[0]}.`
